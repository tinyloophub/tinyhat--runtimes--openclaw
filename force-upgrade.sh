...
#   curl -fsSL https://raw.githubusercontent.com/tinyloophub/tinyhat--runtimes--openclaw/v0.16.11/force-upgrade.sh | sudo bash
#
# or, fetched and run with a pinned runtime ref:
#   sudo TINYHAT_FORCE_UPGRADE_REF=v0.16.11 bash force-upgrade.sh
#
...
REF="${TINYHAT_FORCE_UPGRADE_REF:-v0.16.11}"
